...
public class TriangleTypeTest {
	 ...
	 * @param expectedTriangle expected triangle type based on side lenghts.
	 */
	...
	static Stream<Arguments> testCases() {
		return Stream.of(Arguments.of(1, 2, 4, TriangleType.INVALID), Arguments.of(1, 4, 2, TriangleType.INVALID),
				Arguments.of(4, 1, 2, TriangleType.INVALID), Arguments.of(3, 3, 3, TriangleType.EQUILATERAL),
				Arguments.of(3, 4, 3, TriangleType.ISOSCELES), Arguments.of(4, 3, 3, TriangleType.ISOSCELES),
				Arguments.of(3, 3, 4, TriangleType.ISOSCELES), Arguments.of(3, 4, 5, TriangleType.SCALENE));
	}
}
